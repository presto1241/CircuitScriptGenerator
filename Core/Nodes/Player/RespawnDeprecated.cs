...
[Node("5898c7f7-cb5d-4344-a194-bd09260b12dd")]
public class RespawnDeprecated : INodeBehaviour
{
    ...
    public string GetName() => "Respawn (Deprecated)";
    public string GetVariableQualifiedName() => "respawnDeprecated";
}